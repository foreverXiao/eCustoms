...
namespace eCustoms
{
    ...
    {
        const String passPhraseCON = "r5ttgo09";
        const String saltValueCON = "do3nd0ja";
        const String hashAlgorithmCON = "SHA1";
        const int passwordIterationsCON = 3;
        const String initVectorCON = "A0W48W3ADFW66HSE";
        const int keySizeCON = 256;

        public static string Encrypt
        (
            string plainText,
            string passPhrase = passPhraseCON,
            string saltValue = saltValueCON,
            string hashAlgorithm = hashAlgorithmCON,
            int passwordIterations = passwordIterationsCON,
            string initVector = initVectorCON,
            int keySize = keySizeCON
        )
        {
